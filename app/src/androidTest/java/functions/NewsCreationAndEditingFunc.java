...
public class NewsCreationAndEditingFunc {
    ...
    public static void timeInput(String hours, String minutes) {
        ...
        NewsCreationAndEditingScreen.timeTextInputOfNews.perform(click());
        NewsCreationAndEditingScreen.buttonForSwitchToTextInput.perform(click());
        onView(DataHelper.withIndex(withClassName(is("androidx.appcompat.widget.AppCompatEditText")), 0)).perform(replaceText(hours));
        onView(DataHelper.withIndex(withClassName(is("androidx.appcompat.widget.AppCompatEditText")), 1)).perform(replaceText(minutes));
        NewsCreationAndEditingScreen.okButton.perform(click());
    }
