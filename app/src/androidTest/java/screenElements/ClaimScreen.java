...
public class ClaimScreen {
    ...
    public static ViewInteraction firstCommentDescriptionOfClaim = onView(DataHelper.withIndex(withId(R.id.comment_description_text_view), 0));
    public static ViewInteraction firstCommentatorNameOfClaim = onView(DataHelper.withIndex(withId(R.id.commentator_name_text_view), 0));
    public static ViewInteraction firstCommentDateOfClaim = onView(DataHelper.withIndex(withId(R.id.comment_date_text_view), 0));
    public static ViewInteraction firstCommentTimeOfClaim = onView(DataHelper.withIndex(withId(R.id.comment_time_text_view), 0));
