...
public class MainScreen {
    ...
    public static ViewInteraction buttonToExpandFirstNews = onView(DataHelper.withIndex(withId(R.id.view_news_item_image_view), 0));
    public static ViewInteraction descriptionOfFirstNews = onView(DataHelper.withIndex(withId(R.id.news_item_description_text_view), 0));
    public static ViewInteraction titleOfFirstNews = onView(DataHelper.withIndex(withId(R.id.news_item_title_text_view), 0));
    public static ViewInteraction titleOfThirdNews = onView(DataHelper.withIndex(withId(R.id.news_item_title_text_view), 2));
    public static ViewInteraction dateOfFirstNews = onView(DataHelper.withIndex(withId(R.id.news_item_date_text_view), 0));
    ...
    public static ViewInteraction descriptionOfFirstClaim = onView(DataHelper.withIndex(withId(R.id.description_material_text_view), 0));
    public static ViewInteraction executorOfFirstClaim = onView(DataHelper.withIndex(withId(R.id.executor_name_material_text_view), 0));
    public static ViewInteraction planeDateOfFirstClaim = onView(DataHelper.withIndex(withId(R.id.plan_date_material_text_view), 0));
    public static ViewInteraction planeTimeOfFirstClaim = onView(DataHelper.withIndex(withId(R.id.plan_time_material_text_view), 0));
}